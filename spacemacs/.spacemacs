...
you should place your code here."
  ...
  (add-hook 'dart-mode-hook 'gradle-mode)

  ;; TODO this isn't consistent yet
  ...
  ;; Keybindings for gradle-mode
  (spacemacs/declare-prefix "og" "gradle")
  (spacemacs/set-leader-keys "ogx" 'gradle-execute)
  (spacemacs/set-leader-keys "ogc" 'gradle-clean)
  )
